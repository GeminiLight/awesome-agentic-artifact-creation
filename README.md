<div align="center">
  ...
  <p>
    ...
    <a href="#catalog-analysis">
      <img alt="Papers: 177" src="https://img.shields.io/badge/Papers-177-2A9D8F?style=flat-square">
    </a>
...
<p align="center">
  <img src="visualization/family-trends.svg" alt="Stacked count and share charts showing yearly coverage of the six artifact families" width="100%">
</p>
...
- **Catalog coverage:** 177 papers spanning **2024–2026**, from **47 publication sources**; 162 systems and 15 benchmarks.
- **Dual-axis coverage:** 146 papers (**82.5%**) carry both artifact and application labels; 24 are artifact-only and 7 application-only.
- **Largest artifact family:** 2D Visual Artifacts — **45 papers (25.4%)**.
- **Largest application context:** Creative Production — **63 papers (35.6%)**.
- **Strongest cross-axis concentrations:** Video Artifacts × Creative Production — **19**, 2D Visual Artifacts × Scientific Research — **15**, Spatial Artifacts × Engineering Design — **14**.
- **System-name coverage:** 154 of 162 systems (**95.1%**) have a verified name.
